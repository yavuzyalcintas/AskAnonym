  ...
  return (
    <div className="px-40 py-10 text-gray-900 dark:text-gray-100">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to askanonym.com
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to askanonym.com, accessible from{" "}
            <Link
              href="https://www.askanonym.com"
              rel="noreferrer"
              target={"_blank"}
            >
              https://www.askanonym.com
            </Link>
          </p>
        </li>
        <li>
      ...
      <p>
        ...
        performance of an obligation under these Terms shall not effect a partys
      ...
      <ul>
        <li>
          By email:
          <a href="mailto:no-reply@askanonym.com">no-reply@askanonym.com</a>
        </li>
      </ul>
    </div>
  );
